...
function Footer() {
  return (
    <div className="bg-[#5a554d]">
      <h1 className="text-4xl flex justify-center pt-8 font-normal text-white">
        Subscribe & get up to30% OFF
      </h1>
      <div className="flex gap-8 justify-center pt-8">
        <div className="border-white border rounded-full w-100 h-15  py-2">
          <input
            className=" text-white flex-1 border-white rounded-full py-2 px-8 outline-0 cursor-pointer"
            type="text"
        ...
        <div>
          <div>
            <button className=" text-white border rounded-full w-48 h-15   cursor-pointer">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="flex gap-12 container mx-auto pt-12 justify-between">
        <div className="ml-12">
          <h2 className=" text-white text-2xl font-bold pt-4">BOOKING.COM</h2>
          <p className="text-2 font-medium mt-2 pt-6 text-white">
